...
public class ContextTest {
  ...
  public void setup() throws Exception {
    ...
    String appOnGithub = "https://github.com/appium/java-client/raw/master/src/test/java/io/appium/java_client/WebViewApp.app.zip";
    ...
    // sauce caps
    capabilities.setCapability("name", "java-client: ContextTest");
